...
shoppingList.pop();
shoppingList.unshift('Dog Food');
shoppingList.shift();

var indexOfButter = shoppingList.indexOf('butter');
...
console.log(mirror('YOOOO'));

var colors =['yellow','blue','Blue','red']
var randomLetters= ['abc','ccd','ddB','b','B']

function removeBsstring (str){
 ...
 function removeBs (arr) {
    ...
    arr.forEach(function (str){
        output.push(removeBsstring(str));
    });
 }

console.log(removeBs(colors));
